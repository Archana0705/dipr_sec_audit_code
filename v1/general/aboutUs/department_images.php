...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    $sql = "SELECT  id, file_name, file_blob, mimetype, created_by, created_on, updated_by, updated_on, designation, name, sequence FROM  departments_pics WHERE  language = :P0_LANGUAGE ORDER BY  sequence ASC;";
