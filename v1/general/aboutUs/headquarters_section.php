...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    $sql = "SELECT  id, sections, phone, sequence, language, created_by, created_on, updated_by, updated_on FROM  tn_sections_hq WHERE  language = :P0_LANGUAGE ORDER BY  sequence ASC;";
