...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    $sql = "SELECT ID, press_note_name, uploaded_by, uploaded_on, press_note_no, attachment_name, mimetype, pn_date  FROM tn_press_notes  WHERE language = :P0_LANGUAGE  AND (pn_date = TO_DATE(:P33_SELECT_DATE, 'MM/DD/YYYY')  OR (:P33_SELECT_DATE IS NULL AND pn_date BETWEEN CURRENT_DATE - INTERVAL '10 days' AND CURRENT_DATE)) ORDER BY pn_date DESC;";
    ...
    try {
        ...
        error_log("Error during press note retrieval: " . $e->getMessage());
        http_response_code(500);
